...
heart_training <- clean_csv('../data/modelling/training-split.csv')
...
write_csv(heart_training, '../data/modelling/training-split_new.csv')
...
write_csv(heart_testing, '../data/modelling/testing-data_new.csv')