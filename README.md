...
docker-compose up -d
```
4. Copy the URL that will come up that looks something like `http://127.0.0.1:8888/lab/workspaces/auto-N/tree/analysis.ipynb` into your web browser. This will open Jupyter Lab in the root directory of this analysis. 
